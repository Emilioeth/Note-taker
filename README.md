  ...
  ![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Roboto+Condensed&size=30&pause=2000&color=18BC9C&width=435&lines=Note+Taker;By+Emili0)

  ![Project Img](/public/assets/images/readmeIMG.png)
  
  ## Description
  The note takes is a js app that allows you to write and save notes as you wish for everyone to see, as well as see the notes posted.

  [Link](https://the-notee-taker.herokuapp.com)

  ![visitors](https://visitor-badge.glitch.me/badge?page_id=Emilioeth.Note+Taker&left_color=blue&right_color=blue)
  ...
  This app does not need any installation, you can just go straigth to the webpage with the link posted above, and start creating notes!
